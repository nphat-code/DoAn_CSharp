...
*   [ ] **Phát một bài:** Bấm nút Play xanh lá cây trên một Album hoặc Danh sách phát bất kỳ.
*   [ ] **Thanh PlayerBar dưới cùng:**
    *   [ ] Bấm Pause / Play xem nhạc có dừng và phát tiếp mượt mà không.
    *   [ ] Bấm Chuyển bài (Next) và Quay lại (Prev) xem nhạc có đổi không.
    *   [ ] Kéo chuột trên thanh tiến trình (Seek bar) để tua bài hát xem có chính xác không.
    *   [ ] Điều chỉnh thanh Âm lượng to/nhỏ/tắt tiếng.
