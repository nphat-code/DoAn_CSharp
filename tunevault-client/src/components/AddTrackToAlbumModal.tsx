                  ...
                  <div key={track.id} className="flex items-center justify-between p-2 hover:bg-white/5 rounded-md group">
                    <div className="flex items-center gap-3 overflow-hidden">
                      <div className="w-10 h-10 bg-zinc-700 rounded-sm flex-shrink-0">
                        {track.coverUrl && (
                          <img src={track.coverUrl.startsWith('http') ? track.coverUrl : `https://tunevault-api.onrender.com${track.coverUrl}`} alt="" className="w-full h-full object-cover rounded-sm" />
                        )}
                      </div>
