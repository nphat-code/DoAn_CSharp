        ...
        {step === 1 && (
          <>
            ...
            <form onSubmit={handleNextStep1} className="w-full flex flex-col gap-4 items-center">
              ...
              <button type="button" className="w-full max-w-[324px] border border-zinc-500 hover:border-white text-white font-bold py-3.5 rounded-full flex items-center justify-center gap-3 transition">
