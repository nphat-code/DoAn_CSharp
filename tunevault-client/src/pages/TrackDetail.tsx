...
export const TrackDetail = () => {
  ...
  useEffect(() => {
    if (track?.coverUrl) {
      ...
      const baseUrl = track.coverUrl.startsWith('http') ? track.coverUrl : track.coverUrl?.startsWith('http') ? track.coverUrl : `https://tunevault-api.onrender.com${track.coverUrl}`;
  ...
  const coverUrl = track.coverUrl ? track.coverUrl?.startsWith('http') ? track.coverUrl : `https://tunevault-api.onrender.com${track.coverUrl}` : "https://i.scdn.co/image/ab67616d0000b27341ea2ea7ea8a5be92d3c1f62";
  const artistAvatar = track.artistAvatarUrl ? track.artistAvatarUrl?.startsWith('http') ? track.artistAvatarUrl : `https://tunevault-api.onrender.com${track.artistAvatarUrl}` : "https://i.scdn.co/image/ab67616d00001e023192276cb04c3da1dd1f2cf8"; // Default avatar
