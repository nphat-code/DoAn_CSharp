                ...
                {results.artists.map(artist => (
                  ...
                  >
                    <div className="w-full aspect-square bg-zinc-700 rounded-full mb-4 shadow-lg flex items-center justify-center relative overflow-hidden">
                      {artist.avatarUrl ? (
                        <img src={`http://localhost:5183${artist.avatarUrl}`} alt={artist.name} className="w-full h-full object-cover" />
                      ) : (
                ...
                {results.playlists.map(playlist => (
                  ...
                  >
                    <div className="w-full aspect-square bg-zinc-700 rounded-md mb-4 shadow-lg flex items-center justify-center relative overflow-hidden">
                      {playlist.coverUrl ? (
                        <img src={playlist.coverUrl.startsWith('http') ? playlist.coverUrl : `http://localhost:5183${playlist.coverUrl}`} alt={playlist.name} className="w-full h-full object-cover" />
                      ) : (
