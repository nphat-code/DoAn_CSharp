        ...
        {step === 1 && (
          <>
            ...
            <div className="w-full max-w-[324px] flex flex-col gap-3">
              <button type="button" onClick={handleGoogleLogin} className="w-full border border-zinc-500 hover:border-white text-white font-bold py-3.5 rounded-full flex items-center justify-center gap-3 transition disabled:opacity-50">
                {loading ? (
